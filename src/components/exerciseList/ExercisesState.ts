...
export class ExercisesState {
    ...
    // @observable public exercisesCount: number = Math.floor(Math.random() * (this.maxRounds - 10) + 10);
    ...
    //  @action setMaxRounds = (value: number) => {
    ...
    @computed private get exercisesCount(): number {
        return Math.floor(Math.random() * (this.maxRounds - 10) + 10);
    }
